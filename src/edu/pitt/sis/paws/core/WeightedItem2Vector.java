...
public class WeightedItem2Vector<E extends iItem2> extends Item2Vector<E>
{
	...
	public synchronized boolean addAll(WeightedItem2Vector<E> c)
	{
		boolean res = super.addAll(c);
		if(res)
	...
	public synchronized boolean addAll(int index, WeightedItem2Vector<E> c) 
	{
		boolean res = super.addAll(index, c);
		if(res)
	...
	public void addAllNew(WeightedItem2Vector<E> appendant)
	{
		WeightedItem2Vector<E> appendant__ = new  WeightedItem2Vector<E>();
		appendant__.addAll(appendant);
		appendant__.removeAll(this);
		addAll(appendant__);
	}
